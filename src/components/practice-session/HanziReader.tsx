...
export const HanziReader = () => {
  ...
  const [useSerif] = useState(() => random(0, 1) >= 0.5);
  ...
  return (
    <div className="grow flex items-center justify-center">
      <FlashCard
        title="Hanzi Recall"
        onSkip={() => markWordComplete("skipped")}
      >
        <h1 className="text-lg font-bold">What does this mean?</h1>
        <div className="text-center my-4">
          <p className={classNames("text-5xl", { "hanzi-serif": useSerif })}>
            {currentWord.word}
          </p>
          {isRevealed && (
            <div>
